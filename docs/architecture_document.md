...
| RNF5   | O sistema deve usar a abordagem _Session Based Authentication_, armazenando as sessões dos usuários em banco de dados.                                                                                                                                                                                             |
| RNF6   | As respostas dos estudantes aos quizzes devem ser vinculadas exclusivamente ao nome de usuário escolhido por eles ao início de cada partida, impedindo a identificação direta dos participantes por meio de informações pessoais, garantindo o anonimato e a privacidade dos jogadores durante e após a atividade. |
| RNF7   | O sistema deve suportar até 60 estudantes participando de um quiz ao mesmo tempo, sem aumento significativo de tempo de resposta.                                                                                                                                                                                  |
| RNF8   | O tempo de processamento das requisições realizadas à API deve ser inferior a 200ms, considerando apenas o tempo de execução no servidor e desconsiderando a latência da rede.                                                                                                                                     |
| RNF9   | O sistema não pode apresentar a falha de segurança "quebra de controle de acesso".                                                                                                                                                                                                                                 |
| RNF10  | O sistema não pode apresentar a falha de segurança "falhas de criptografia".                                                                                                                                                                                                                                       |
| RNF11  | O sistema não pode apresentar a falha de segurança "injeção"                                                                                                                                                                                                                                                       |
