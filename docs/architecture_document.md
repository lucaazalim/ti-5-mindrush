...
| RNF13  | O software não pode apresentar a falha de segurança "quebra de controle de acesso".                                                                                                                                                                                                                                |
| RNF14  | O software não pode apresentar a falha de segurança "falhas de criptografia".                                                                                                                                                                                                                                      |
| RNF15  | O software não pode apresentar a falha de segurança "injeção"                                                                                                                                                                                                                                                      |
