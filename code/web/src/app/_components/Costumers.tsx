...
const Costumers = () => {
    return (
        <div className="w-3/4 mx-auto text-center pt-24" id="costumers">
            <motion.div 
            ...
            <motion.div
                            ...
                            viewport={{ once: true }}
                            className="text-[25px] pb-5"
                            >Escolas de todo o Brasil já estão utilizando nossa plataforma!</motion.div>
            <motion.div 
